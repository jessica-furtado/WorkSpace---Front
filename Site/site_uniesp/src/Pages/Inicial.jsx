        ...
        <box sx={{ p: 4, backgroundColor: '#f0f0f0', borderRadius: '8px' }}>
            ...
            <Paper elevation={3} sx={{ p: 3, mb: 4, backgroundColor: '#ffffff', borderRadius: '8px' }}>
                ...
                <Typography variant='body1'>
                    A Faculdade é uma instituição de ensino superior!
                </Typography>
            </Paper>
            <Grid container spacing={4}>
                <Grid item xs={12} md={6}>
                    ...
                    <Typography variant='body1'>
                        Fique atualizado com as últimas notícias de eventos!
                    </Typography>
                    </Paper>
                </Grid>
                <Grid item xs={12} md={6}>
                    ...
                    <Typography variant='body1'>
                        Acesse a área administrativa para gerencias notícias.
                    </Typography>
                    </Paper>
                </Grid>
            </Grid>
